...
#SBATCH --job-name=test-ucf101-download
...
python /scratch/tkg5kq/MARS/utils1/extract_slices.py /scratch/tkg5kq/datasets/ucf-101/ucf101/UCF-101/ /scratch/tkg5kq/datasets/ucf-101/ucf101/wslices/ ${SLURM_ARRAY_TASK_ID} $((SLURM_ARRAY_TASK_ID + 1)) >> "${logfile}" 2>&1
sleep 45